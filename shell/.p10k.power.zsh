# Generated by Powerlevel10k configuration wizard on 2020-05-02 at 17:46 CEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 51840.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, angled separators, sharp heads, flat tails, 1 line, sparse, few icons,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=74
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=235
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=235
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=167

  # Status when some part of a pipe command fails and the overall exit status is also non-zero.
  # It may look like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_VISUAL_IDENTIFIER_EXPANSION='✘'
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=235
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=167
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_THRESHOLD=235
